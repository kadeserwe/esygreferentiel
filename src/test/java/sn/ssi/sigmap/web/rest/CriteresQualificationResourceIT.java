...
public class CriteresQualificationResourceIT {
    ...
    public void createCriteresQualification() throws Exception {
        ...
        restCriteresQualificationMockMvc.perform(post("/api/criteres-qualifications")
    ...
    public void checkLibelleIsRequired() throws Exception {
        int databaseSizeBeforeTest = criteresQualificationRepository.findAll().size();
        // set the field null
        criteresQualification.setLibelle(null);

        // Create the CriteresQualification, which fails.
        ...
        List<CriteresQualification> criteresQualificationList = criteresQualificationRepository.findAll();
        assertThat(criteresQualificationList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void updateCriteresQualification() throws Exception {
        ...
        updatedCriteresQualification
            .libelle(UPDATED_LIBELLE);

        restCriteresQualificationMockMvc.perform(put("/api/criteres-qualifications")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteCriteresQualification() throws Exception {
        ...
        restCriteresQualificationMockMvc.perform(delete("/api/criteres-qualifications/{id}", criteresQualification.getId())
