...
class PiecesAdministrativesResourceIT {
  ...
  void createPiecesAdministratives() throws Exception {
    ...
    restPiecesAdministrativesMockMvc
      .perform(
        post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(piecesAdministratives))
      )
  ...
  @Test
  @Transactional
  void putNewPiecesAdministratives() throws Exception {
    // Initialize the database
    piecesAdministrativesRepository.saveAndFlush(piecesAdministratives);
    ...
    updatedPiecesAdministratives.code(UPDATED_CODE).libelle(UPDATED_LIBELLE).localisation(UPDATED_LOCALISATION);
  ...
  void putWithMissingIdPathParamPiecesAdministratives() throws Exception {
    ...
    restPiecesAdministrativesMockMvc
      .perform(
        put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(piecesAdministratives))
      )
  ...
  void partialUpdatePiecesAdministrativesWithPatch() throws Exception {
    ...
    partialUpdatedPiecesAdministratives.libelle(UPDATED_LIBELLE).localisation(UPDATED_LOCALISATION);
  ...
  void fullUpdatePiecesAdministrativesWithPatch() throws Exception {
    ...
    partialUpdatedPiecesAdministratives.code(UPDATED_CODE).libelle(UPDATED_LIBELLE).localisation(UPDATED_LOCALISATION);
  ...
  void patchWithMissingIdPathParamPiecesAdministratives() throws Exception {
    ...
    restPiecesAdministrativesMockMvc
      .perform(
        patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(piecesAdministratives))
      )
      .andExpect(status().isMethodNotAllowed());
  ...
  void deletePiecesAdministratives() throws Exception {
    ...
    restPiecesAdministrativesMockMvc
      .perform(delete(ENTITY_API_URL_ID, piecesAdministratives.getId()).accept(MediaType.APPLICATION_JSON))
