...
public class HierarchieResourceIT {
    ...
    public void createHierarchie() throws Exception {
        ...
        restHierarchieMockMvc.perform(post("/api/hierarchies")
    ...
    public void updateHierarchie() throws Exception {
        ...
        restHierarchieMockMvc.perform(put("/api/hierarchies")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteHierarchie() throws Exception {
        ...
        restHierarchieMockMvc.perform(delete("/api/hierarchies/{id}", hierarchie.getId())
