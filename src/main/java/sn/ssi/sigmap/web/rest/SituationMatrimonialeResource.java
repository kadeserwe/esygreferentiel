...
public class SituationMatrimonialeResource {
  ...
  public ResponseEntity<SituationMatrimoniale> createSituationMatrimoniale(@Valid @RequestBody SituationMatrimoniale situationMatrimoniale)
   ...
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PatchMapping(value = "/situation-matrimoniales/{id}", consumes = "application/merge-patch+json")
