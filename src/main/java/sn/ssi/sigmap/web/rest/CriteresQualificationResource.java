...
public class CriteresQualificationResource {
  ...
  public ResponseEntity<CriteresQualification> createCriteresQualification(@Valid @RequestBody CriteresQualification criteresQualification)
  ...
  public ResponseEntity<CriteresQualification> updateCriteresQualification(
    ...
    @Valid @RequestBody CriteresQualification criteresQualification
  ) throws URISyntaxException {
   ...
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PatchMapping(value = "/criteres-qualifications/{id}", consumes = "application/merge-patch+json")
  public ResponseEntity<CriteresQualification> partialUpdateCriteresQualification(
    @PathVariable(value = "id", required = false) final Long id,
    @NotNull @RequestBody CriteresQualification criteresQualification
  ) throws URISyntaxException {
  ...
  public List<CriteresQualification> getAllCriteresQualifications() {
    log.debug("REST request to get all CriteresQualifications");
    return criteresQualificationRepository.findAll();
  }
