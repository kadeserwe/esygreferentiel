...
public class CriteresQualificationResource {
    ...
    public ResponseEntity<CriteresQualification> createCriteresQualification(@Valid @RequestBody CriteresQualification criteresQualification) throws URISyntaxException {
    ...
    public ResponseEntity<CriteresQualification> updateCriteresQualification(@Valid @RequestBody CriteresQualification criteresQualification) throws URISyntaxException {
